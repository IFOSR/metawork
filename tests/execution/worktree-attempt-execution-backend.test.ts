...
import { WorktreeAttemptExecutionBackend } from '../../src/execution/worktree-attempt-execution-backend.js';

describe('WorktreeAttemptExecutionBackend', () => {
  it('runs a process in the writable worktree and collects its receipt output', async () => {
    ...
    const adapter = new WorktreeAttemptExecutionBackend();
