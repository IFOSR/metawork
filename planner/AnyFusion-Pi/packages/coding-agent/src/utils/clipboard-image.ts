...
function isWSL(env: NodeJS.ProcessEnv = process.env): boolean {
	// AnyFusion Planner is supported in Linux containers, where Docker Desktop
	// may expose a Microsoft-flavoured kernel string without WSL host tools.
	// Only explicit WSL environment markers are authoritative here.
