...
export const APP_TITLE: string = "AnyFusion Planner";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".pi";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = "ANYFUSION_PLANNER_HOME";
export const ENV_SESSION_DIR = "ANYFUSION_PLANNER_SESSION_DIR";
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.ANYFUSION_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	if (!baseUrl) return "";
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// AnyFusion Planner user config paths (~/.anyfusion/agent/*)
// =============================================================================
