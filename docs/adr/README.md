...
Workspace admission, and Server-owned Feishu transport lifecycle. Its
2026-08-27 amendment treats Client startup cwd only as an untrusted default for
new Conversations; attached Conversations retain their durable Workspace. It
amends the foreground-surface implementation evidence in ADR-0031 without
...
| Executor idle management | [ADR-0033](0033-hot-configuration-activation-and-auto-model-routing.md) §2026-09-19 amendment, [ADR-0028](0028-agentclass-model-and-harness-routing-contract.md) §6 | Strict account-wide idle gate, work/config interlock, and bounded Pi/Codex Executor lifecycle management with hot activation |
