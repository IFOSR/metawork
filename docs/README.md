...
## Active Delivery
- [Workspace-scoped Conversation organization design](plans/2026-08-27-workspace-scoped-conversation-organization-design.md): approved Workspace-first product hierarchy with stable Workspace identity, immutable Conversation binding after the first user query, cross-client Conversation directory and activity projection, and detailed replay remaining isolated per Conversation. The [implementation plan](plans/2026-08-27-workspace-scoped-conversation-organization-implementation-plan.md) defines the ADR-first, migration-safe, TDD sequence across Gateway v2, Web, TUI, Feishu, recovery, and native multi-client acceptance.
