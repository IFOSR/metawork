...
## Active Delivery
- [Independent Server/Client and TUI experience design](plans/2026-08-26-independent-server-client-and-tui-experience-design.md): approved process-lifecycle cut for a persistent workspace-neutral Server, independently launched TUI/Web clients, Server-managed Feishu connectivity, Conversation-scoped `/workspace <path>`, a redesigned native TUI, and strict preservation of the current Web experience through a Server projection superset.
- [Independent Server/Client and TUI implementation plan](plans/2026-08-26-independent-server-client-and-tui-experience-implementation-plan.md): approved ADR-first, TDD-sized execution plan covering the hard CLI cutover, Conversation Workspace admission, Server composition extraction, deterministic TUI replay projection, Web golden-flow compatibility gates, lifecycle smokes, security gates, and documentation.
