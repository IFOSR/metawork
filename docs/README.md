...
## Active Delivery
- [Client default Workspace and visibility design](plans/2026-08-27-client-default-workspace-design.md): approved behavior for new TUI/Web Conversations to default to the Client startup directory, attached Conversations to retain their durable Workspace, all Clients to display Server-confirmed Workspace, and Web launch context to avoid path-bearing URLs.
- [Client default Workspace implementation plan](plans/2026-08-27-client-default-workspace-implementation-plan.md): ready-for-implementation TDD plan covering the ADR-0034 amendment, idempotent Workspace initialization, TUI startup hints, one-time Web bootstrap context, Web projection compatibility, Feishu confirmation, and multi-client acceptance.
