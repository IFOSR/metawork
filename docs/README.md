...
## Active Delivery
- [Planner direct Web access design](plans/2026-08-30-planner-direct-web-access-design.md): accepted boundary for read-only `web_fetch`/`web_search` in semantic Planner turns and mandatory Executor routing for side effects or schedulable work. The [implementation plan](plans/2026-08-30-planner-direct-web-access-implementation-plan.md) records the TDD sequence.
